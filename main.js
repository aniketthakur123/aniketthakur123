async function saveToLocalStorage(event) {
    ...
    try {
      ...
      let res = await axios.post(
        "https://crudcrud.com/api/24ea3cd4020e47ca8d823b2ab42a6c6c/appointmentData",
        obj
      );
      if (res.status === 201) {
  ...
  async function editUser(userId, experience, description, category) {
    try {
      ...
      let response = await axios.put(
        `https://crudcrud.com/api/24ea3cd4020e47ca8d823b2ab42a6c6c/appointmentData/${userId}`,
        obj
      );
  ...
  async function deleteUser(obj) {
    try {
      let res = await axios.delete(
        `https://crudcrud.com/api/24ea3cd4020e47ca8d823b2ab42a6c6c/appointmentData/${obj}`
      );
      //console.log(obj)
      if (res.status === 200) {
